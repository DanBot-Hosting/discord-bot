...
import { Message, MessageReaction, PartialMessageReaction, PermissionResolvable, TextChannel } from "discord.js";
...
const event: Event = {
    ...
    once: false,
    async execute(client: ExtendedClient, Discord: typeof import("discord.js"), r: PartialMessageReaction) {
        try {
