    ...
    async execute(client: ExtendedClient & any, Discord: typeof import("discord.js"), oldMember: GuildMember, newMember: GuildMember) {
        try {
            ...
            const log = new Discord.EmbedBuilder()
                ...
                .setAuthor({ name: oldMember.user.tag, iconURL: oldMember.user.displayAvatarURL({ extension: "png", forceStatic: false }), url: `https://discord.com/users/${oldMember.user.id}` })
